...
header {
	z-index: 999;
	background: url('http://lorempixel.com/600/600/sports/');
...
#email-button {
  ...
  color: #fff;
  -webkit-box-shadow: 3px 4px 5px 0px rgba(85,85,85,1);
-moz-box-shadow: 3px 4px 5px 0px rgba(85,85,85,1);
box-shadow: 3px 4px 5px 0px rgba(85,85,85,1);
